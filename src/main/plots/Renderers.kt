...
interface PlotRenderer {
    fun plot(points: List<PlotPoint>, policies: List<PolicyFactory>, data: Data)
}
...
abstract class TableRendererBase(val policiesInHeader: Boolean) : PlotRenderer {
    ...
    private fun generatePoliciesInHeader(points: List<PlotPoint>, policies: List<PolicyFactory>, data: Data): Table {
        val header = arrayOf("Variable") + policies.map(PolicyFactory::name)
    ...
    private fun generateVariablesInHeader(points: List<PlotPoint>, policies: List<PolicyFactory>, data: Data): Table {
    ...
    override fun plot(points: List<PlotPoint>, policies: List<PolicyFactory>, data: Data) {
